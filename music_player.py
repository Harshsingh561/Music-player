...
root.iconbitmap("C:\\Users\\DELL\\PycharmProjects\\pythonProject3\\music_player_1.ico")
...
class MusicPlayer:
    def __init__(self):
        ...
        self.p_unp = 'Resume'
        self.m_unm= 'Mute'
        self.song_mut = MP3(self.a[self.i])
        self.song_length=self.song_mut.info.length
